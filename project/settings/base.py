...
GRAPPELLI_ADMIN_TITLE = "todomvc-backend"
...
ADMINS = (
    ('todomvc-backend administrator', 'donotreply@blitzagency.com'),
)
...
SECRET_KEY = r"zev9fx!zz-*euf%e4acuxabhsl-p$_o+44vvciez6av^6&7+_h"
